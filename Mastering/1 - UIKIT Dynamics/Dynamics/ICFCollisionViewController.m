...
- (void)viewDidLoad
{
    ...
    [gravityBehavior setGravityDirection:CGVectorMake(0.2f, 0.2f)]; //property changed after printing of the book
    ...
    collisionBehavior.translatesReferenceBoundsIntoBoundary = YES;//设置自定义的边界，
